...
export default {
    ...
    methods: {
        getAllMovies: function () {
            axios
            .get('https://api.themoviedb.org/3/discover/movie/?api_key=d10c1bd7eca8fdf88d0274921e84e3b8&certification_country=us&vote_count.gte=1000&language=fr')
            .then( (resp) => {
